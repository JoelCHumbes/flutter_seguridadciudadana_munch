...
class FormDatosRuc extends StatefulWidget {
  const FormDatosRuc({Key? key}) : super(key: key);

  @override
  State<FormDatosRuc> createState() => _FormDatosRucState();
}

class _FormDatosRucState extends State<FormDatosRuc> {
